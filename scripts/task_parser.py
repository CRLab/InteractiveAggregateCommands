...
class Lexer(object):
    ...
    def t_STOP(self, t): r'stop'; return t
    def t_PAUSE(self,t): r'pause'; return t
    def t_SWITCH(self,t): r'switch'; return t
    def t_ROBOT(self,t): r'robot'; return t
    def t_QUIT(self,t): r'quit'; return t
    def t_NAMED(self,t): r'named'; return t
